  ...
  return (
    <div className="mt-[10vh] bg-dark text-slate-200 divide-y-4 divide-main">
      <section className="py-10 flex flex-col  items-center">
        <div className="flex w-3/4 my-10 items-center justify-center">
      ...
      <section className="py-10 flex flex-col items-center">
        <article className="lg:w-1/2 ">
          <div className="flex flex-col relative mt-[-105px] mb-16">
            <img
              src={ClaytonImg}
              className="bg-white rounded-full h-44 w-44 mx-auto mb-4"
              alt="Dog"
              loading="lazy"
            ></img>
